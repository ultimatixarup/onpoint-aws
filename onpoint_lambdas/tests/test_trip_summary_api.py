...
def test_summarize_item_falls_back_when_summary_is_map(monkeypatch):
    add_common_to_path()
    ...
    item = {
        ...
        "summary": {
            "M": {
                "distance": {
                    "M": {
                        "cityMiles": {"N": "5.033105100003013"},
                        "highwayMiles": {"N": "62.63419680003426"},
                        "nightMiles": {"N": "0"},
                    }
                }
            }
    ...
    out = mod._summarize_item(item)
    assert out["milesDriven"] == 67.66730190003728
