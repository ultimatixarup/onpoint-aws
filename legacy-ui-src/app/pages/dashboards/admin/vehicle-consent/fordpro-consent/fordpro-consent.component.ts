...
@Component({
  selector: 'app-fordpro-consent',
  templateUrl: './fordpro-consent.component.html',
  styleUrls: ['./fordpro-consent.component.scss']
})
export class FordproConsentComponent implements OnInit {
