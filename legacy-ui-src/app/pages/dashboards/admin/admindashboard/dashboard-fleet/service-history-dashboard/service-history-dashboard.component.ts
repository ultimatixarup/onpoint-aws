...
@Component({
  selector: 'app-service-history-dashboard',
  templateUrl: './service-history-dashboard.component.html',
  styleUrls: ['./service-history-dashboard.component.scss']
})
export class ServiceHistoryDashboardComponent  implements OnInit {
...
loadVehicleMaintenanceData() {
  ...
  const requests = {
    ...
    brake: this.dashboardsService.getBrakeService(this.fleetIdData, selectedVin, startDate, endDate)
  };
