...
export class LiveFeedComponent implements OnInit, AfterViewInit {
  ...
  ngOnInit(): void {
    ...
    const rawUrl = `https://dashcam.fleettrack.ai/sso?access_token=${this.token}&redirect_path=live-view&_=${timestamp}`;
    // ?startTimeUTC=2025-05-19T10:30:00.000Z&endTimeUTC=2025-06-02T11:30:00.000Z
